...
\author{Florian Priv\'e,$^{\text{1,}*}$ Bogdan Pasaniuc,$^{\text{2,3,4,5}}$ and Bjarni J. Vilhj\'almsson$^{\text{1,6,7}}$}
...
However, we note that we are able to achieve an $r^2$ of 0.677 [0.671, 0.682] when using the penalized regression implementation of \cite{prive2019efficient} while restricting to all variants within a 1Mb window of the \textit{LPA} gene.
