...
\begin{figure}[p]
	\centerline{\includegraphics[width=\textwidth]{mean-local-h2}}
	\caption{ \label{}}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=\textwidth]{mean-local-h2-perc}}
	\caption{ \label{}}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=\textwidth]{local-h2-p}}
	\caption{ \label{}}
\end{figure}

\begin{figure}[p]
\centerline{\includegraphics[width=\textwidth]{ukbb_compare-transfo}}
\caption{ \label{}}
\end{figure}
